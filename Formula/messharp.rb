class Messharp < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/quality-gates/messharp/releases/download/v0.2.4/messharp_0.2.4_darwin_arm64.tar.gz", tag: "v0.2.4"
      sha256 "f09f436b02d3d6a14ee66a03dce5923dbe9591c7a3b24edbdf76ecffde03bc8b"
    end

    on_intel do
      url "https://github.com/quality-gates/messharp/releases/download/v0.2.4/messharp_0.2.4_darwin_amd64.tar.gz", tag: "v0.2.4"
