class Messpy < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/quality-gates/messpy/releases/download/v0.1.5/messpy_0.1.5_darwin_arm64.tar.gz", tag: "v0.1.5"
      sha256 "4a5ce2488ef4780ef3f177125a3f561d4f29ecbfddbc4bbdfd86bfe7935e4107"
    end

    on_intel do
      url "https://github.com/quality-gates/messpy/releases/download/v0.1.5/messpy_0.1.5_darwin_amd64.tar.gz", tag: "v0.1.5"
