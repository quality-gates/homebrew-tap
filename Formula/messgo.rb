class Messgo < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/quality-gates/messgo/releases/download/v0.2.2/messgo_0.2.2_darwin_arm64.tar.gz", tag: "v0.2.2"
      sha256 "4147aca448bbb2190f84b39527d03371e5b92e1d8a6e3f217d6c37f4229cb16e"
    end

    on_intel do
      url "https://github.com/quality-gates/messgo/releases/download/v0.2.2/messgo_0.2.2_darwin_amd64.tar.gz", tag: "v0.2.2"
