class Messrust < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/quality-gates/messrust/releases/download/v0.1.1/messrust_0.1.1_darwin_arm64.tar.gz?version=0.1.1"
      sha256 "dc9e05ff54d6ba00db4e376a3acfe6d675941ed4a4ee6f219ed05bdd2c8425c0"
    end

    on_intel do
      url "https://github.com/quality-gates/messrust/releases/download/v0.1.1/messrust_0.1.1_darwin_amd64.tar.gz?version=0.1.1"
