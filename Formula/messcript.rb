class Messcript < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/quality-gates/messcript/releases/download/v0.1.0/messcript_0.1.0_darwin_arm64.tar.gz"
      sha256 "d12f2bf6c26050233d3b9c7b087ed5fe8a7494651d9d7e30670eaa7b8971af93"
    end

    on_intel do
      url "https://github.com/quality-gates/messcript/releases/download/v0.1.0/messcript_0.1.0_darwin_amd64.tar.gz"
