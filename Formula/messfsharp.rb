class Messfsharp < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/quality-gates/messfsharp/releases/download/v0.1.0/messfsharp_0.1.0_darwin_arm64.tar.gz", tag: "v0.1.0"
      sha256 "ffe28467034e18d89c052ffe94eafe451e78a2491ad3e94f87ebe4e4b896af36"
    end

    on_intel do
      url "https://github.com/quality-gates/messfsharp/releases/download/v0.1.0/messfsharp_0.1.0_darwin_amd64.tar.gz", tag: "v0.1.0"
